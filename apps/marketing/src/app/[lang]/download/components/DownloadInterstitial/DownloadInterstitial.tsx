...
export function DownloadInterstitial({
	...
	// The browser told us nothing about the chip, so the x64 build was picked
	// because it runs on either machine, not because an Intel Mac was detected.
	// Say that instead of labelling the guess as a detection.
					...
					<div className="max-w-2xl">
						...
						{archUnconfirmed ? (
							<p className="mt-4 text-muted-foreground text-sm">
								<Trans id="marketing.download.archUnconfirmed">
									Your browser doesn't report which chip you have, so this is
									the Intel build. It runs on Apple Silicon too, through
